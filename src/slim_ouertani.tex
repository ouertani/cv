...
\vspace{8pt}
{\sl \textit {Archimate Certified},} Open Group  \hfill   Score 82\%, 02-2016
\\
{\sl \textit {Archimate Foundation},} Open Group  \hfill   Score 97\%, 02-2016
\\
{\sl \textit {Cloud Trainer},} Arcitura  \hfill   10-2015
\\
{\sl \textit {Cloud Architect},} Arcitura  \hfill  With Honors, 10-2015
\\
{\sl \textit {Cloud Professional},} Arcitura  \hfill  With Honors, 09-2015
\\
...
\begin{ncolumn}{2}
{\bf  BLOGGGING }                                     &  {\bf INTERVIEW } \\
http://java.dzone.com/users/slim.ouertani           & {\sl Paremus, SCA with OSGI,} {\bf David Savage}  \\
http://ouertani.github.io                           & Shttp://www.prosyst.com/ \\
http://www.jroller.com/ouertani                     & 07.02.2009 \\
http://twitter.com/ouertani                         & http://www.jroller.com/ouertani/entry/interview\_paremus\_sca\_with\_osgi

\end{ncolumn}


\begin{ncolumn}{2}
{\bf  MAGAZINE}                                          &  {\bf STAMPLE   } \\
{\sl From Microservices to SOA} -  20.07.2015            & https://stample.co\\
Service Technology Magazine     -  Issue XCI             & Scala, Akka, Play \\
http://servicetechmag.com/I91/0715-1                     & ElasticSearch, MongoDb, Amazon S3, GreenCloud
...
{\sl Problematic \& OSGi design pattern ,} \url {http://www.paremus.com}  \hfill   01.2009 \\
...
{\sl Pour le fun : for-comprehension \`a la sauce Java 8}  \hfill    23.07.2015 \\
\vspace{-5mm}
\begin{itemize}
\item[]  \scriptsize http://www.infoq.com/fr/articles/for-comprehension-sauce-java-8
\end{itemize}
\vspace{-2mm}
