...
{\sl Advanced OSGi ,} www.sagem.com  \hfill   08.2009 \\
  By :Slim Ouertani
  Problematic & OSGi design pattern :
  - White board
  - Extender

{\sl Problematic \& OSGi design pattern ,} http://www.paremus.com/  \hfill   01.2009 \\
  By :David Savage \& Mike Francis
   SCA architecture with Newton
   http://newton.codecauldron.org


{\sl OSGi,} http://www.prosyst.com/  \hfill   05.2008 \\
By : Roman Roelofsen
OSGi architecture and environment. Future directive and OSGi applications in the server world.


\vspace{0.2in}
\section{\centerline{Interview}}
\vspace{8pt}
{\sl Paremus, SCA with OSGI,} David Savage, http://www.prosyst.com/  \hfill   02.2009 \\
...
\vspace{8pt}
\begin{ncolumn}{3}
{\bf InfoQ Fr Editor}                                   &  {\bf Blogging } \\
http://www.infoq.com/fr/author/Slim-Ouertani            &  http://java.dzone.com/users/slim.ouertani \\
...
\begin{ncolumn}{2}
{\bf Open source }                    &  {\bf Stample   } \\
https://github.com/ouertani           & https://stample.co\\
http://www.reactive-streams.org       &  Senior Scala developer \\
                                      & Akka, Play, ElasticSearch, MongoDb, Amazon S3, GreenCloud \\
\end{ncolumn}
